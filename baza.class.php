...
class Baza {
    ...
    //nasi podaci
    const server = "localhost"; //uvijek localhost;
    const korisnik = "WebDiP2021x057";  //nas podatak...WebDiP2021x057
    const lozinka = "admin_fyU9";   //nas admin_fyU9
    const baza = "WebDiP2021x057";  //nas
