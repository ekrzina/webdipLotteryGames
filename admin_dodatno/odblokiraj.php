...
$upit = "UPDATE Korisnik SET StatusKorisnika = 0 WHERE idKorisnik = " . $id;
$veza->updateDB($upit);
...
$stringDnevnik = $vri . "/Korisnik " . $_SESSION['korisnik'] . " odblokira korisnika " . $id . "./Upit: " . $upit . "/Tip radnje: 2";
